...
(function () {
    'use strict';
    angular.module('crams').controller('CramsAllocationViewController', CramsAllocationViewController);

    CramsAllocationViewController.$inject = ['$location', '$route', '$scope', '$rootScope', '$routeParams', 'CramsApiService', 'LookupService', 'FlashService', 'CramsUtils'];

    function CramsAllocationViewController($location, $route, $scope, $rootScope, $routeParams, CramsApiService, LookupService, FlashService, CramsUtils) {
        var vm = this;
